...
- Candidate source commit: `dcf712be5f88278f2a1fd87b533f88a150465105` (`Harden ZIP extra timestamp handling`)
...
- Independent Sol review of the reviewed prior candidate / predecessor HEAD `037002913f2f0f1892e27a9d6477d2251d9a5677` (`Harden ZIP metadata canonicalization`) plus artifact SHA-256 `7238b74e13167a59310cd1e9e14ff56048733a8755a272602a0aa6b0064a38c9` rejected that predecessor with no P0. Findings were the stale predecessor HEAD and runtime paths in this document, unsupported acceptance wording in README/CHANGELOG, and incomplete UT/NTFS/UX extra-field canonicalization. That REJECT is not a review of this exact current candidate. This exact current candidate (HEAD `dcf712be5f88278f2a1fd87b533f88a150465105`, `Harden ZIP extra timestamp handling`) is unpublished, has not been accepted, and requires a fresh independent Sol review. Publication is pending and is not authorized.
...
- Independent Sol REJECT of the reviewed prior candidate / predecessor (HEAD `037002913f2f0f1892e27a9d6477d2251d9a5677`, `Harden ZIP metadata canonicalization`, SHA-256 `7238b74e13167a59310cd1e9e14ff56048733a8755a272602a0aa6b0064a38c9`) had no P0. That REJECT is not a review of this exact current candidate. This exact current candidate (HEAD `dcf712be5f88278f2a1fd87b533f88a150465105`, `Harden ZIP extra timestamp handling`) is unpublished, has not been accepted, and requires a fresh independent Sol review. Publication is pending and is not authorized by this document.
...
- P2 provenance: the exact committed HEAD named here is `dcf712be5f88278f2a1fd87b533f88a150465105` (`Harden ZIP extra timestamp handling`). The reviewed prior candidate / predecessor is `037002913f2f0f1892e27a9d6477d2251d9a5677` (`Harden ZIP metadata canonicalization`). This exact current candidate is unpublished and is not a published identity. A fresh independent Sol review is required. Tag and GitHub publication remain pending and are not authorized by this document. This worker did not commit, tag, publish, or accept.
